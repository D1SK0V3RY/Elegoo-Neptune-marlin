...
#define STRING_CONFIG_H_AUTHOR "vehystrix" // Original author or contributor.
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 14.54f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.2053f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.1187f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.1686f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
...
#define PIDTEMPBED
  ...
  #define DEFAULT_BED_KP 211.04
  #define DEFAULT_BED_KI  41.22
  #define DEFAULT_BED_KD 720.33
...
#elif NEPTUNE_3_PLUS
    // X feedrate was 80.00, recalibrated to 80.12
    // Y feedrate was 80.00, recalibrated to 80.22
    // E feedrate was 390.00, recalibrated to 424.83
  #define DEFAULT_AXIS_STEPS_PER_UNIT   {80.12, 80.22, 400.00, 424.83}
#elif NEPTUNE_3_MAX
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.0256 // (mm) Distance from real junction edge
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {-28.5, 22, 0 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
